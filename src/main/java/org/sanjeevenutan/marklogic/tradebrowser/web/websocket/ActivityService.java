...
import static org.sanjeevenutan.marklogic.tradebrowser.config.WebsocketConfiguration.IP_ADDRESS;
...
public class ActivityService implements
	...
	public ActivityDTO sendActivity(@Payload ActivityDTO activityDTO,
		...
		activityDTO.setTime(dateTimeFormatter.print(Calendar.getInstance()
				.getTimeInMillis()));
