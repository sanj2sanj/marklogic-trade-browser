...
import org.sanjeevenutan.marklogic.tradebrowser.security.AjaxAuthenticationFailureHandler;
import org.sanjeevenutan.marklogic.tradebrowser.security.AjaxAuthenticationSuccessHandler;
import org.sanjeevenutan.marklogic.tradebrowser.security.AjaxLogoutSuccessHandler;
import org.sanjeevenutan.marklogic.tradebrowser.security.AuthoritiesConstants;
import org.sanjeevenutan.marklogic.tradebrowser.security.Http401UnauthorizedEntryPoint;
import org.sanjeevenutan.marklogic.tradebrowser.web.filter.CsrfCookieGeneratorFilter;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	public void configure(WebSecurity web) throws Exception {
		web.ignoring().antMatchers("/scripts/**/*.{js,html}")
				...
				.antMatchers("/assets/**").antMatchers("/swagger-ui/**")
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.csrf()
				...
				.deleteCookies("JSESSIONID").permitAll().and().headers()
